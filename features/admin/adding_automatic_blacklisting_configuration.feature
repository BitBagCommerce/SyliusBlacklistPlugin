...
Feature: Adding a new automatic blacklisting configuration
    ...
    @ui @javascript
    Scenario: Adding a new automatic blacklisting configuration with max number of payment failures
        When I go to the create automatic blacklisting configuration page
    ...
    @ui @javascript
    Scenario: Adding a new automatic blacklisting configuration with max number of orders and max number of payment failures
        When I go to the create automatic blacklisting configuration page
